/*
MySQL script version 5.7

This file contains a script of SQL commands for creating, populating, and querying a 'Categories' table and related 'Products' table. 

Assumptions:
This script assumes a database 'Inventory' already exists.
